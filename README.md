...
- [ ] أنشئ Google Sheet جديد وسمّه `SmartKiosk`
...
- [ ] أنشئ ريبو جديد على GitHub اسمه `smartkiosk`
- [ ] ارفع الملفات (index.html + google-apps-script/)
- [ ] اذهب إلى Settings → Pages
- [ ] Source: Deploy from branch → main
- [ ] انسخ رابط الموقع (مثل: https://username.github.io/smartkiosk/)
