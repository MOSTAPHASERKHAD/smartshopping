...
const queries = [
  ...
  { name: 'password_reset_tokens', sql: 'SELECT count(*) as count FROM password_reset_tokens;' },
  { name: 'email_verification_tokens', sql: 'SELECT count(*) as count FROM email_verification_tokens;' },
...
console.log('--- PRODUCTION POST-MIGRATION 0002 INTEGRITY (READ-ONLY) ---\n');
